...
ODP = {	
	...
	worldlinkerateSetCategories : function()
	{
		...
		{
			$('.content').append(
													 '<form class="'+encodeURIComponent(categories[id])+'" action="http://editors.dmoz.org/editors/editcat/editrelation?cat='+encodeURIComponent(categories[id])+'&type=altlang" method="post" target="_blank">'+
